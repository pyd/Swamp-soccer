...
export default [
  {
    ...
    description:
      "Premier tournoi en Finlande il y a 11 ans avec 13 équipes.Le concept est inspiré des skieurs de cross-country qui s’entraînent dans la boue l’été. Aujourd’hui, plus de 200 équipes européennes jouent à ce sport…Un tournoi a eu lieu du 20 au 22 juin 2008 à Dunoon en Écosse (Royaume-Uni). Le trophée du Championnat vaut 500 livres Sterling… Quelques règles du Swamp Soccer 3 types d’équipe qui ne jouent pas ensemble : hommes, femmes et mixtes 2 manches de 12 minutes 6 joueurs sur le terrain (inclus 1 gardien de but).Tous les joueurs d’une même équipe doivent porter la même couleur de chandail.",
  },
  {
    id: 2,
    intro:
  ...
  },
  {
    id: 4,
    intro:
      "Chaque année est organisé le championnat du monde de swamp soccer, lequel réuni plusieurs milliers de personnes. En 2016 près de 3000 participants représentant 7 pays différents se sont rassemblés au championnat du monde. ",
